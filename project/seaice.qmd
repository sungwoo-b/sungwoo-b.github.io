...
This project aims to explore and analyze NOAA’s geospatial data and introduce projection techniques that map it onto a plane.
It further extends to integrating animal telemetry data for a comprehensive analysis.
