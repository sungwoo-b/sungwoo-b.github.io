...
원격 감지 데이터 중에는 널리 알려진 해빙에 관한 데이터도 포함되어 있습니다.
이 프로젝트에서는 남극의 해빙 농도 데이터를 가지고 평면 지도에 시각화할 수 있는 투영법을 소개하고 투영된 지도에 Adelie 펭귄 추적 데이터를 추가하여 어떠한 분석이 가능한지를 보여줍니다.
...
그러나 아래에서 소개하는 두 가지 방법을 사용하면 해빙 데이터 뿐 아니라 다른 지리 공간 데이터도 평면 지도에 시각화할 수 있습니다.
